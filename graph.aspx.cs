...
public partial class graph : System.Web.UI.Page
{
    ...
    protected Graph3D SelectDataGrapg3D(string id, string readable, string rich, string timely, string url, string name)
    {
        ...
        sel.style = /*"#3267D2" */"#7DC1FF";
        if (name.Length > 10)
        {
            string sname = name.Substring(0, 10) + "...";
            sel.h = sname;
        }
        else
        {
    ...
    protected void cr_google()
    {
        Process.Start("C:\\105專題\\105316126\\exe_test.exe");
    }
    protected void Button2_Click1(object sender, EventArgs e)
    {
        Server.Transfer("105project.aspx", true);
    }
